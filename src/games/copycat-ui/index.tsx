    ...
    channel
      .on(
        ...
        (payload: { new: Tables<'room_events'> }) => {
          queryClient.setQueryData<Tables<'room_events'>[]>(['room_events', roomId], (cur = []) =>
            [payload.new, ...cur].slice(0, 50),
          )
        },
      )
      .subscribe()
  ...
  return (
    <div className="grid flex-1 grid-cols-12">
      <div className="col-span-9 space-y-3 p-4">
        <div className="text-muted-foreground text-sm">Connection {connection}</div>
      ...
      <aside className="col-span-3 space-y-3 border-l p-3">
        ...
        <div className="mt-4 font-medium">Events</div>
